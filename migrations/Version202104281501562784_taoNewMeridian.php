...
final class Version202104281501562784_taoNewMeridian extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Configure MetadataGuardian.';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->unregisterMetadataGuardian();
    }

    private function configureMetadataGuardian(array $options): void
    {
        $metadataGuardian = $this->getServiceManager()->get(ItemMetadataGuardian::SERVICE_ID);
        $metadataGuardian->setOptions($options);
    ...
    private function unregisterMetadataGuardian(): void
    {
        $this->getMetadataService()->getImporter()->unregister(
            MetadataImporter::GUARDIAN_KEY,
            ItemMetadataGuardian::class
        );
    }
